        ...
        <div className="pt-32 pb-12 md:pt-40 md:pb-20">
          ...
          <div className="max-w-sm mx-auto">
            ...
            <div className="text-gray-300 text-center mt-6">
              Already using Trakfy? <Link href="/signin" className="text-purple-300 hover:text-gray-200 transition duration-150 ease-in-out">Sign in</Link>
            </div>
          </div>
