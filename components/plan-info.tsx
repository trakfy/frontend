...
export default function PlanInfo(data: any) {
  ...
  return (
    <div className="bg-white rounded-md shadow-lg w-full h-auto p-10 flex flex-col items-center">
      <div className="mb-4">
        <span className="text-md font-medium">Plan: </span>
        <span className="text-md font-semibold">{userPlanType}</span>
      </div>
      <div className="mb-4">
      ...
      <div className="text-center">
        <span className="text-md font-medium">Plan Used: </span>
        <span className="text-md ml-auto font-semibold">{userPlanUsed}</span>
        <span className="text-md font-medium"> / {userPlanLimit}</span>
      </div>
      <a href="/billing">
